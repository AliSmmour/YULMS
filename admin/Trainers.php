...
{
$table='';
$records="SELECT staff_id,staff_name,staff_email,staff_address,staff_phone_num,staff_gender,fac.f_id,bld_name
...
?>
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Dashboard <small>Trainers View</small></h1>
            <ol class="breadcrumb">
              <li class="active"><i class="fa fa-dashboard"></i>  Trainers Information </li>
            </ol>
          ...
          <div class="col-lg-12">
            <div class="panel panel-success">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fas fa-chalkboard-teacher"></i> Trainers </h3>
              </div>
 ...
 <div id="edit" class="modal fade">  
      <div class="modal-dialog">  
           <div class="modal-content">  
                ...
                <div class="modal-body" id="staff_detail">
                  <form action="staff_save_changes.php" method="post">
                    <div id="edit_form">
                    </div><br>
