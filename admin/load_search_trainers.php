...
if(isset($_POST["search_key"]))
{
	...
	if ($_POST['search_key'] !='')
	{
		$sql="SELECT staff_id,staff_name,staff_email,staff_address,staff_phone_num,staff_gender,fac.f_id,bld_name
          ...
          WHERE fac.f_id = stf.f_id and stf.staff_id  in (SELECT staff_id FROM course_table) and (staff_name like '%$sdata%'|| staff_email like '%$sdata%'||staff_phone_num like                '%$sdata%'||staff_address like '%$sdata%'||staff_gender like '%$sdata%'||bld_name like '%$sdata%')
